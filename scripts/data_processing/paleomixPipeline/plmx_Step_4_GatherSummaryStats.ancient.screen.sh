...
wd=/u/flashscratch/a/ab08028/GalapagosRails/paleomix/testMapping

headers=$SCRATCH/GalapagosRails/samples/jaime.Bird.Screen.all.txt
outdir=$SCRATCH/GalapagosRails/paleomix/summaryStats
mkdir $outdir
outfile=$outdir/plmx.aDNA.summary.stats.screening.txt
REF=Ficedula_albicollis.FicAlb_1.4.dna.toplevel # note that you'll collect ALL ref genomes for most stats; you're
#just setting the REF here for the MD coverage stats, which you're only collecting for the flycatcher for now 
